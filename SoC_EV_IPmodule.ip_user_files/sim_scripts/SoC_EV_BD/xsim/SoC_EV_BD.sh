...
export RDI_DATADIR="/media/wonhyeok/data/XILINX/2025.1/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L proc_sys_reset_v5_0_17 -L microblaze_v11_0_15 -L microblaze_riscv_v1_0_5 -L lmb_v10_v3_0_15 -L lmb_bram_if_cntlr_v4_0_26 -L blk_mem_gen_v8_4_11 -L axi_lite_ipif_v3_0_4 -L mdm_riscv_v1_0_5 -L axi_uartlite_v2_0_39 -L xlconstant_v1_1_10 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_35 -L axi_vip_v1_1_21 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L axi_iic_v2_1_11 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SoC_EV_BD xil_defaultlib.SoC_EV_BD xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SoC_EV_BD -key {Behavioral:sim_1:Functional:SoC_EV_BD} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_cb0a.protoinst" -protoinst "protoinst_files/SoC_EV_BD.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/wonhyeok/data/XILINX/2025.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SoC_EV_BD.wdb xsim.dir libdpi.so)
